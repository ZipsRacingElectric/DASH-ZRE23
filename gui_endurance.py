...
class View(gui.View):
    ...
    def Update(self):
        ...
        self.temp3Stat.Set (self.database["Temperature_Inverter_Max"])
        self.temp4Stat.Set (self.database["Temperature_Inverter_Mean"])
        self.temp5Stat.Set (self.database["Temperature_Motor"])